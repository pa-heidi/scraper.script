...
import { PlanFactoryService } from "./plan-factory.service";
import { PlanDocumentationService } from "./plan-documentation.service";
...
export class MCPOrchestratorService implements MCPOrchestrator {
    ...
    private planFactory: PlanFactoryService;
    private planDocs: PlanDocumentationService;
    ...
    constructor(config?: Partial<MCPOrchestratorConfig>) {
        ...
        this.contentAnalysisService = new ContentAnalysisService(this.playwrightExecutor);
        this.planFactory = new PlanFactoryService();
        this.planDocs = new PlanDocumentationService();
    }
        ...
        try {
                ...
                async () => {
                    ...
                    if (enhancedContentUrls && enhancedContentUrls.length > 0) {
                        const contentAnalysis =
                            await this.contentAnalysisService.analyzeContentUrlsWithHtml(
                                enhancedContentUrls,
            ...
            const planResult = await this.executeWorkflowStep(
                ...
                async () => {
                    ...
                    const scrapingPlan =
                        await this.planFactory.createScrapingPlanFromAnalysis({
                            url,
                            enhancedContentUrls,
                            listSelector,
                            paginationSelector,
                    ...
                    const result: PlanGenerationResult = {
                        ...
                        humanReadableDoc: this.planDocs.generateHumanReadableDoc(
                            scrapingPlan,
                            siblingResults,
                            contentAnalysis
                        ),
